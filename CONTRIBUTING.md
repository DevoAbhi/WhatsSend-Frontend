...
- Take a look at the Existing [Issues](https://github.com/DevoAbhi/WhatsSend-Frontend.git/issues) or create your own Issues!
...
```
   git clone https://github.com/DevoAbhi/WhatsSend-Frontend.git
```
